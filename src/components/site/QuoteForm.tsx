        ...
        <div className="grid lg:grid-cols-5 gap-10 lg:gap-16 items-center">
          <div className="lg:col-span-2">
            ...
            <p className="mt-5 text-muted-foreground text-lg">
              Để lại thông tin, đội ngũ kỹ sư Solar Win sẽ khảo sát, tư vấn miễn phí và gửi báo giá
          ...
          <form
            onSubmit={submit}
            className="lg:col-span-3 p-6 lg:p-10 rounded-3xl bg-card border border-border shadow-elevated"
          >
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <Field
                ...
                name="address"
                placeholder="Phường, Thành phố Vinh"
